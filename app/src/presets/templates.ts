...
export const PRESET_AURORA_BOREALIS: PresetTemplate = {
  ...
  description: 'Northern lights aurora curtains with rainbow circular spectrum',
  settings: { backgroundColor: '#020611' },
  layers: [
    {
      ...makeShaderLayer('aurora', 'Aurora BG', {
        speed: staticParam(0.42),
        intensity: staticParam(1.3),
        scale: staticParam(1.45),
        color1: staticParam('#6ef7cf'),
        color2: staticParam('#2f6dff'),
        color3: staticParam('#bf7cff'),
        audioReactivity: staticParam(1.55),
        feedbackEnabled: true,
        feedbackAmount: staticParam(0.14),
        feedbackZoom: staticParam(1.001),
        feedbackRotate: staticParam(-0.0007),
      }),
      effects: [
        makeVignetteEffect(0.55, 0.38),
      ],
    },
    makeHDCircularSpectrum({
      name: 'Aurora Ring',
      innerRadius: staticParam(96),
      barMaxHeight: staticParam(170),
      barCount: staticParam(92),
      gain: staticParam(0.92),
      attack: staticParam(0.46),
      release: staticParam(0.2),
      barWidthRatio: staticParam(0.74),
      compressionPow: staticParam(1.02),
      colorMode: 'rainbow',
      gradientColor1: staticParam('#75ffe5'),
      gradientColor2: staticParam('#9a7bff'),
      glowStrength: staticParam(1.9),
      rotationSpeed: staticParam(0.06),
      reflectionEnabled: staticParam(false),
      gamma: staticParam(1.16),
      contrast: staticParam(1.02),
    ...
    }),
    {
      ...makeRadialWaveform({
        name: 'Aurora Wave',
        radius: staticParam(80),
        amplitude: staticParam(28),
        lineWidth: staticParam(7),
        color: staticParam('#d8eeff'),
        opacity: staticParam(0.62),
        blendMode: 'add',
      }),
      effects: [
        makeGlowEffect('#8dc9ff', 12),
      ],
    },
  ],
};
